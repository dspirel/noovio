 ...
 */
final class Version20250731070744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task_post (id SERIAL NOT NULL, task_schedule_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, status BOOLEAN DEFAULT NULL, posted BOOLEAN NOT NULL, post_text VARCHAR(2500) DEFAULT NULL, media_urls JSON DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2939F8F6E27E6FE7 ON task_post (task_schedule_id)');
        ...
        $this->addSql('ALTER TABLE task_post ADD CONSTRAINT FK_2939F8F6E27E6FE7 FOREIGN KEY (task_schedule_id) REFERENCES task_schedule (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task_post DROP CONSTRAINT FK_2939F8F6E27E6FE7');
